...
private
  ...
  def find_exact_query_params
    permitted_params = params.permit(:document_type, :email_document_supertype, :government_document_supertype, :gov_delivery_id)
    {
      ...
      slug: permitted_params[:gov_delivery_id],
    }
  end
